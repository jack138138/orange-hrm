...
public class AddUserPage extends Utility
{
    ...
    By employeeHint= By.xpath("//span[contains(text(),'Jack')]");
    ...
    {
        //enter Employee Name "Jack Sparrow"
        sendTextToElement(enterEmployeeName,"Jack");
        clickOnElement(employeeHint);
    }
    public void enterUserName()
    {
        //enter Username
        sendTextToElement(enterUsername,"Sparrow");
    }
